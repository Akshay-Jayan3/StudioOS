          ...
          <Card>
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                ...
                <Link href="/projects" className="text-xs text-zinc-400 hover:text-zinc-700 flex items-center gap-1">
          ...
          <Card>
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                ...
                <Link href="/leads" className="text-xs text-zinc-400 hover:text-zinc-700 flex items-center gap-1">
                  View all <ArrowRight className="w-3 h-3" />
                </Link>
              </div>
            </CardHeader>
