    ...
    <div className="grid grid-cols-2 gap-6">
      ...
      <div className="space-y-4">
        <AgentStatusBanner
          ...
          copyText={output ? `${output.weeklyUpdate.greeting}\n\n${output.weeklyUpdate.progressSummary}\n\n${output.weeklyUpdate.accomplishments.map((a) => `- ${a}`).join("\n")}\n\n${output.weeklyUpdate.closing}` : undefined}
        />
